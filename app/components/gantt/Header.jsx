    ...
    return (
      <div>
        <div style={ { paddingTop: '5px' } }>
          ...
          <Button className='create-btn' disabled={ optionsLoading } onClick={ () => { this.setState({ searchShow: !this.state.searchShow }); } }>Search&nbsp;<i className={ this.state.searchShow ? 'fa fa-angle-double-up' : 'fa fa-angle-double-down' }></i></Button>
          ...
          <div style={ { marginTop: '10px', float: 'right' } }>
            <DropdownButton id='more' pullRight style={ { float: 'right' } } title='More' onSelect={ this.operateSelect.bind(this) }>
              ...
              <MenuItem divider/>
              <MenuItem eventKey='gotolist'>Go to list</MenuItem>
            </DropdownButton>
          </div>
          { sqlTxt &&
