      ...
      <div className='toc-container'>
        <div className='react-menu-container'>
          ...
          <div className='toc-container-body'>
            ...
            <h4 onClick={ toggleShow('adminScheme') }><i className={ this.state.adminSchemeShow ? 'fa fa-minus-square-o' : 'fa fa-plus-square-o' } />Global scheme configuration</h4>
      ...
      <div className='toc-container'>
        <div className='react-menu-container'>
          ...
          <div className='toc-container-body'>
            ...
            <h4 onClick={ toggleShow('projectConfig') }><i className={ this.state.projectConfigShow ? 'fa fa-minus-square-o' : 'fa fa-plus-square-o' } />Project configuration</h4>
          ...
          :
          <h4 className='toc-container-body'>Please select the item to view</h4> }
        </div>
      </div>);
    }
  }
