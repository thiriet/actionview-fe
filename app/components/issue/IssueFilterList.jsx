...
export class IssueFilterList extends Component {
  ...
  render() {
    ...
    const timeFields = [
      ...
      { key: 'expect_start_time', name: 'Expected start date', type: 'Duration', options: [ 'fixed', 'current_variable' ] },
      { key: 'expect_complete_time', name: 'Expected complete date', type: 'Duration', options: [ 'fixed', 'current_variable' ] }
    ];
